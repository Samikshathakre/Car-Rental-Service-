                            ...
                            <form onSubmit={handleSendOtp} className="space-y-6">
                                <div>
                                    <div className="relative">
                                        ...
                                        <div className="absolute inset-y-0 left-12 flex items-center pointer-events-none text-emerald-500 font-medium">
                                            +91
                                        </div>
                                        <input
                                            id="phone"
                                            ...
                                            className="pl-24 w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-gray-50 shadow-sm text-lg"
                                            value={phoneNumber}
                                ...
                                <button
                                    ...
                                    className="w-full bg-emerald-500 text-white py-4 px-4 rounded-xl hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50 transition-colors duration-300 shadow-md font-medium text-lg disabled:bg-emerald-300 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                                >
                            ...
                            <form onSubmit={handleVerifyOtp} className="space-y-8">
                                ...
                                <div className="flex justify-between text-sm">
                                    <button
                                        ...
                                        className="text-emerald-600 font-medium flex items-center space-x-1 hover:text-emerald-800"
                                        disabled={loading}
                                    >
                                        <ArrowLeft size={16} />
                                    ...
                                    {isTimerRunning ? (
                                        ...
                                        <button
                                            ...
                                            disabled={loading}
                                            className="text-emerald-600 font-medium hover:text-emerald-800 disabled:text-emerald-300"
                                        >
                                            Resend Code
                                        </button>
                                    )}
                                ...
                                <button
                                    ...
                                    className="w-full bg-emerald-500 text-white py-4 px-4 rounded-xl hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-opacity-50 transition-colors duration-300 shadow-md font-medium text-lg disabled:bg-emerald-300 disabled:cursor-not-allowed"
                                >
                            ...
                            <form onSubmit={handleNameSubmit} className="space-y-6">
                                <div>
                                    <input
                                        ...
                                        className="w-full px-4 py-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-gray-50 shadow-sm text-lg"
                                        required
                                        disabled={loading}
                                    />
                                </div>
