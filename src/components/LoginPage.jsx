...
//                                             className="w-10 h-14 text-center text-xl font-bold border-0 rounded-full bg-gray-100 focus:outline-none focus:bg-emerald-50 focus:ring-2 focus:ring-emerald-500 shadow-sm transition-all"
//                                             required
//                                         />
//                                     ))}
//                                 </div>
